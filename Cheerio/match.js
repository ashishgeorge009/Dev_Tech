...
//------------------------------
//---creating teams directory
let teampath = path.join(__dirname,"Teams");
if(fs.checkWetherDirPresent(teampath)==false){
...
function handlePlayer(pName, teamName, runs, balls) {
    ...
    let dirPath = path.join(__dirname,"Teams", teamName);
    ...
    let filePath = path.join(__dirname,"Teams", teamName, pName + ".json");
